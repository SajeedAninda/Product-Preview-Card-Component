        ...
        <div className='bg-[#f2ebe3] flex justify-center items-center h-full lg:h-screen'>
            <div className='w-[90%] md:w-[70%] lg:w-[50%] rounded-2xl my-20 flex flex-col lg:flex-row h-full lg:h-[70vh]'>
                <div className="imgDiv w-full lg:w-[50%] h-full">
                    <img className='w-full h-full object-cover rounded-tl-2xl rounded-tr-2xl lg:rounded-tr-none lg:rounded-bl-2xl' src={productImg} alt="" />
                </div>
                <div className="textDiv w-full lg:w-[50%] bg-white p-8 rounded-br-2xl rounded-bl-2xl lg:rounded-tr-2xl lg:rounded-bl-none h-full flex flex-col justify-between space-y-6 lg:space-y-0">
